/*!
 * @file Pico---PIGGIE 1.ino
 * @brief 
 * Base on SeongGinos GUN4ALL https://github.com/SeongGino/ir-light-gun-plus/tree/plus
 * Which is based on Prow's Enhanced Fork from https://github.com/Prow7/ir-light-gun,
 ...
 *
 * @copyright Same as coders before me. 
 * @copyright https://github.com/Fusion-Lightguns/P.I.G.S--Pico-Gun-System/blob/plus/LICENSE 
...
LightgunButtons::Desc_t LightgunButtons::ButtonDesc[] = {
    ...
    {btnGunC, LightgunButtons::ReportType_Mouse, MOUSE_BUTTON5, LightgunButtons::ReportType_Mouse, MOUSE_BUTTON5, LightgunButtons::ReportType_Mouse, MOUSE_BUTTON5, 15, BTN_AG_MASK2},   
    ...
    {btnPedal, LightgunButtons::ReportType_Mouse, MOUSE_BUTTON4, LightgunButtons::ReportType_Mouse, MOUSE_BUTTON4, LightgunButtons::ReportType_Gamepad, PAD_X, 15, BTN_AG_MASK2},
...
void UpdateBindings(bool offscreenEnable)
{
    ...
    LightgunButtons::ButtonDesc[BtnIdx_Calibrate].pin = btnGunC;
